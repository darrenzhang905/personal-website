...
export default function Footer() {
  ...
  return (
    <footer className="section-gradient py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/#skills" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">
                  Skills
                </Link>
              </li>
              <li>
            ...
            <ul className="mt-4 space-y-2">
              <li className="text-gray-600 dark:text-gray-400">
                <span className="flex items-center">
                  ...
                  <a href="mailto:darrenzhang905@gmail.com" className="hover:underline">darrenzhang905@gmail.com</a>
                </span>
              </li>
              ...
              <li className="text-gray-600 dark:text-gray-400">
                <span className="flex items-center">
                  ...
                  <a href="https://linkedin.com/in/darrenzhang905" target="_blank" rel="noopener noreferrer" className="hover:underline">
