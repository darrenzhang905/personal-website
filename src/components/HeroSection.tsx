        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-16">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
              ...
              <span className="block text-gray-900 dark:text-white mt-2">Darren Zhang</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link 
                href="/#projects" 
                className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 py-3 px-8 rounded-md font-medium shadow-lg hover:shadow-xl transition-all"
              >
                View My Work
              </Link>
              <Link 
                href="/#contact" 
                className="border-2 border-gray-900 dark:border-white text-gray-900 dark:text-white py-3 px-8 rounded-md font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
              >
                Let's Connect
              </Link>
            </div>
            ...
            <div className="flex items-center gap-4 mt-10 justify-center lg:justify-start">
              <a href="https://github.com/darrenzhang905" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://linkedin.com/in/darrenzhang905" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
